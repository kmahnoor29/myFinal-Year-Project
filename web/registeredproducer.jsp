  ...
  <div class="navbar-default sidebar" role="navigation">
    <div class="sidebar-nav navbar-collapse">
      <ul class="nav" id="side-menu">
        ...
        <li>
          <a href="registeredcustomer.jsp"><i class="fa fa-user fa-fw"></i> Registration Customers</a>
        </li>

        <li>
          <a href="registeredproducer.jsp"><i class="fa fa-user fa-fw"></i> Registration Tailors</a>
        </li>
            ...
            <table id="consumers" >
              ...
              <%
                ...
                try{
                  ...
                  String sql ="SELECT * FROM registerproducer";
              ...
              <tr>
                ...
                <td><%=resultSet.getString("registration") %></td>
                <td><%=resultSet.getString("gender") %></td>
                <td><a href="delete4.jsp?id=<%=resultSet.getString("id") %>"><button type="button" class="delete">Reject</button></a>
