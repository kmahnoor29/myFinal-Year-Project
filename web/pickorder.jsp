        ...
        <div class="col-lg-12">
          <div class="row">
            ...
            <ul class="nav nav-tabs">
              ...
              <li class="active"><a data-toggle="tab" href="#home"><p class="text-info"><b>Orders</b></p></a></li>
            ...
            <table id="dtVerticalScrollExample" class="table table-striped table-bordered table-sm" cellspacing="0"
              ...
              <tr>
                ...
                <td> <a id="allFiles" class="hyperLink" href="ImagesView.jsp"><button type="button">Images</button></a>
                <td> <a  class="hyperLink" href="userChat2.jsp"><button type="button">Chat</button></a></td>
            ...
            <table id="dtVerticalScrollExample" class="table table-striped table-bordered table-sm" cellspacing="0"
              ...
              <tr>
                ...
                <td><%=resultSet.getString("description") %></td>
                <td><%=resultSet.getString("email") %></td>
                <td> <a id="allFiles" class="hyperLink" href="ImagesView.jsp"><button type="button">Images</button></a></td>
                <td> <a  class="hyperLink" href="userChat2.jsp"><button type="button">Chat</button></a></td>
