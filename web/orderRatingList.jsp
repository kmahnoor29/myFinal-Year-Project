  ...
  <div class="navbar-default sidebar" role="navigation">
    <div class="sidebar-nav navbar-collapse">
      <ul class="nav" id="side-menu">
        ...
        <li>
          <a href="customerdashboad.jsp"><i class="fa fa-table fa-fw"></i>Dashboard</a>
          <a href="viewsize.jsp"><i class="fa fa-table fa-fw"></i>Standard Size Orders</a>
        </li>
        ...
        <div class="col-lg-12">
          <div class="row">
            ...
            <ul class="nav nav-tabs">
              ...
              <li class="active"><a data-toggle="tab" href="#home"><p class="text-info"><b>Order Rating List</b></p></a></li>
            ...
            <table id="dtVerticalScrollExample" class="table table-striped table-bordered table-sm" cellspacing="0"
              ...
              <%
                ...
                try{
                  ...
                  String sql ="SELECT * FROM ratee where orderid='"+orderid+"'";
