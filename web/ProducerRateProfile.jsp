    ...
    <ul class="nav navbar-right navbar-top-links" style="background-color:#008B8B;" >
      ...
      <li class="dropdown">
        <a class="dropdown-toggle" data-toggle="dropdown" href="#" style="background-color:#008B8B; color:white;">
          ...
          CheckCustAndPro producer = new CheckCustAndPro();

          String Email= request.getParameter("email");

          String Emaill;
          Emaill= producer.checkProducer(Email);
  ...
  <div class="navbar-default sidebar" role="navigation">
    <div class="sidebar-nav navbar-collapse">
      <ul class="nav" id="side-menu">
        ...
        <li>
          <a href="ProducerRatingProfile.jsp"><i class="fa fa-table fa-fw"></i>Check Tailor Rating Profile</a>
        </li>
          ...
          <div class="row">
            ...
            <%
              ...
              try{
                ...
                String sql ="SELECT image,firstname,lastname FROM producer where email='"+Email+"'";
