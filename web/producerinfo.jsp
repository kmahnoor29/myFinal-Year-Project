          ...
          <div class="row">
            <div class="col-sm-3"><!--left col-->
              ...
              <ul class="list-group">
                ...
                <li class="list-group-item text-right"><span class="pull-left"><strong><p class="text-info">Standard Orders
               <%   try{
                  int count=0;
                  connection = DriverManager.getConnection(connectionUrl + dbName, userId, password);
                  statement=connection.createStatement();
                  String sql ="SELECT  count(email) FROM standard";
                ...
                <li class="list-group-item text-right"><span class="pull-left"><strong><p class="text-info">Custom Orders
                  <%   try{
                    int count=0;
                    connection = DriverManager.getConnection(connectionUrl + dbName, userId, password);
                    statement=connection.createStatement();
                    String sql ="SELECT  count(email) FROM custom";
                    resultSet = statement.executeQuery(sql);
                    while(resultSet.next()){
                  %>
                </p></strong></span>
                ...
                <li class="list-group-item text-right"><span class="pull-left"><strong><p class="text-info">Total Customers

                  <%   try{
                    int count=0;
                    connection = DriverManager.getConnection(connectionUrl + dbName, userId, password);
                    statement=connection.createStatement();
                    String sql ="SELECT  count(email) FROM registercustomer";
                    resultSet = statement.executeQuery(sql);
                    while(resultSet.next()){
                  %>
                ...
                <li class="list-group-item text-right"><span class="pull-left"><strong><p class="text-info">No. of reports you posted
                  <% try{
                  int count=0;
                  connection = DriverManager.getConnection(connectionUrl + dbName, userId, password);
                  statement=connection.createStatement();
                  String sql ="SELECT count(email) FROM report where email='"+email+"' ";
                  resultSet = statement.executeQuery(sql);
                  while(resultSet.next()){
