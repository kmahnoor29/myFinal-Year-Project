      ...
      <div class="row">
        <div class="col-lg-12">
          <div class="row">
            ...
            <br>
            <form class="form" action="orderRatingList.jsp" method="post" id="registrationForm">
              <div class="col-xs-6">
                <label for="orderid"><h4>Enter Order ID</h4></label>
                <input pattern="^[0-9]*$" required="true" rows="4" class="form-control" name="id" id="orderid" placeholder="Give Order ID" title="enter Order ID to view Ratings if any."/>
              </div>
