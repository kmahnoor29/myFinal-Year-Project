...
<div id="wrapper">
  ...
  <div id="page-wrapper">
    <div class="container-fluid">
      <div class="row">
        <div class="col-lg-12">
          <h1 class="page-header">Report Information</h1>
        </div>
        <!-- /.col-lg-12 -->
      </div>
      <!-- /.row -->
        ...
        <div class="col-lg-12">
          <div class="row">
            ...
            <ul class="nav nav-tabs">
              ...
              <li class="active"><a data-toggle="tab" href="#home"><p class="text-info"><b>Reports</b></p></a></li>
            ...
            <table id="dtVerticalScrollExample" class="table table-striped table-bordered table-sm" cellspacing="0"
              ...
              <tr>
                ...
                <td><%=resultSet.getString("reportEmail") %></td>
                <td><%=resultSet.getString("reportMessage") %></td>
                <td><%=resultSet.getString("dateNtime") %></td>
                <td><a href="deletereport.jsp?id=<%=resultSet.getString("id") %>"><button type="button" class="delete">Delete</button></a></td>
