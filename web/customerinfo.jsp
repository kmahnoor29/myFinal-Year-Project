                    ...
                    <div class="row">
                        <div class="col-sm-3"><!--left col-->
                            ...
                            <ul class="list-group">
                                ...
                                <li class="list-group-item text-right"><span class="pull-left"><strong><p class="text-info">My Standard Orders
                                    <%   try{
                                        int count=0;
                                        connection = DriverManager.getConnection(connectionUrl + dbName, userId, password);
                                        statement=connection.createStatement();
                                        String sql ="SELECT  count(email) FROM standard where email='"+email+"'";
                                ...
                                <li class="list-group-item text-right"><span class="pull-left"><strong><p class="text-info">My Custom Orders
                                    <% try{
                                        int count=0;
                                        connection = DriverManager.getConnection(connectionUrl + dbName, userId, password);
                                        statement=connection.createStatement();
                                        String sql ="SELECT count(email) FROM custom where email='"+email+"' ";
                                        resultSet = statement.executeQuery(sql);
                                        while(resultSet.next()){
                                ...
                                <li class="list-group-item text-right"><span class="pull-left"><strong><p class="text-info">Total Tailors
                                    <% try{
                                        int count=0;
                                        connection = DriverManager.getConnection(connectionUrl + dbName, userId, password);
                                        statement=connection.createStatement();
                                        String sql ="SELECT count(email) FROM registerproducer";
                                        resultSet = statement.executeQuery(sql);
                                        while(resultSet.next()){
