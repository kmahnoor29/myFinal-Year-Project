...
<div id="wrapper">
    ...
    <ul class="nav navbar-right navbar-top-links" style="background-color:#008B8B;" >
      ...
      <li class="dropdown">
        ...
        <ul class="dropdown-menu dropdown-user">
          <li><a href="producerprofile.jsp"><i class="fa fa-user fa-fw"></i> User Profile</a>
          <li class="divider"></li>
          <li><a href="/Logout2Servlet"><i class="fa fa-sign-out fa-fw"></i> Logout</a>
          </li>
          <li><a href="/ChangePasswordForm2.jsp"><i class="fa fa-sign-out fa-fw"></i> Change Password?</a>
          </li>
  ...
  <div class="navbar-default sidebar" role="navigation">
    <div class="sidebar-nav navbar-collapse">
      <ul class="nav" id="side-menu">
        ...
        <li>
          <a href="pickorder.jsp"> <i class="fa fa-shopping-cart fa-fw"></i>Pick Order</a>
        </li>
  ...
  <div id="page-wrapper">
    <div class="container-fluid">
      <div class="row">
        <div class="col-lg-12">
          <h1 class="page-header">Rating Information</h1>
        </div>
        <!-- /.col-lg-12 -->
      </div>
      <!-- /.row -->
        ...
        <div class="col-lg-12">
          <div class="row">
            ...
            <ul class="nav nav-tabs">
              ...
              <li class="active"><a data-toggle="tab" href="#home"><p class="text-info"><b>Order Ratings</b></p></a></li>

            </ul>
            <br>
            <form class="form" action="CustomerRateProfile.jsp" method="post" id="registrationForm">
              <div class="col-xs-6">
                <label for="email"><h4>Enter Customer Email</h4></label>
                <input type="email" required="true" rows="4" class="form-control" name="userEmail" id="email" placeholder="Give Tailor Email" title="enter Tailor email to view Ratings Profile."/>
              </div>
              ...
              <div class="form-group">
                <div class="col-xs-12">
                  <br>
                  <a href="rating.jsp"><button  class="btn btn-lg btn-success" type="submit"><i class="glyphicon glyphicon-ok-sign"></i>View</button></a>
                </div>
              </div>
