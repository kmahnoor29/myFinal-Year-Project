      ...
      <div class="row">
        <div class="col-lg-12">
          <div class="row">
            ...
            <br>
            <form class="form" action="AdminCustomer.jsp" method="post" id="registrationForm">
              <div class="col-xs-6">
                <label for="email"><h4>Enter Customer Email</h4></label>
                <input type="email" required="true" rows="4" class="form-control" name="userEmail" id="email" placeholder="Give Customer Email" title="enter Tailor email to view Ratings Profile."/>
              </div>
              ...
              <div class="form-group">
                <div class="col-xs-12">
                  <br>
                 <button  class="btn btn-lg btn-success" type="submit"><i class="glyphicon glyphicon-ok-sign"></i>View</button>
                </div>
              </div>
